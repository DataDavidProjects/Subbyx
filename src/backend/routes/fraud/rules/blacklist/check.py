...
@router.post("/v1/rules/blacklist/check", response_model=RuleCheckResponse)
def check_blacklist(request: RuleCheckRequest) -> RuleCheckResponse:
    ...
    return RuleCheckResponse(triggered=False, rule="blacklist", reason="Email not in blocklist")
